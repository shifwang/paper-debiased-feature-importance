...
for ind in range(20):
    ...
    np.savetxt('../intermediate/02_enhancer/permuted{}_X_train.csv'.format(ind), X_train, delimiter=',')
    np.savetxt('../intermediate/02_enhancer/permuted{}_y_train.csv'.format(ind), y_train, delimiter=',')
    ...
    np.savetxt('../intermediate/02_enhancer/permuted{}_noisy_features.csv'.format(ind), noisy_features, delimiter=',')
